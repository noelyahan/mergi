...
func TestResizeScaleDown(t *testing.T) {
	img, _ := mergi.Import(io.NewFileImporter("./testdata/hedgehog-child-3636026_960_720.jpg"))
...
func TestMergeScaleDown(t *testing.T) {
	template := "TT"
	img1, _ := mergi.Import(io.NewFileImporter("./testdata/cherry-3074284_960_720.jpg"))
	img2, _ := mergi.Import(io.NewFileImporter("./testdata/avocado-3210885_960_720.jpg"))
