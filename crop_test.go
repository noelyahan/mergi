...
func TestCrop(t *testing.T) {
	...
	Export(loader.NewFileExporter(img, "out.png"))
}
...
func TestCropAndMerge(t *testing.T) {
	img, _ := Import(loader.NewFileImporter("./testdata/tree-146874_960_720.png"))
	...
	Export(loader.NewFileExporter(res, "out.png"))
}

// helper functions
func getImages(template string) []image.Image {
	imgs := make([]image.Image, 0)
	img, _ := Import(loader.NewFileImporter("./testdata/evraiki-2514543_240_180.jpg"))
