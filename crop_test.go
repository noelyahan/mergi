...
func TestCrop(t *testing.T) {
	...
	Export(io.NewFileExporter(img, "out.png"))
}
...
func TestCropAndMerge(t *testing.T) {
	img, _ := Import(io.NewFileImporter("./testdata/tree-146874_960_720.png"))
...
func getImages(template string) []image.Image {
	...
	img, _ := Import(io.NewFileImporter("./testdata/evraiki-2514543_240_180.jpg"))
