...
func _getImages() (img1 image.Image, img2 image.Image) {
	scale := 4
	img1, _ = Import(io.NewFileImporter("./testdata/nature-3042751_960_720.jpg"))
	img1, _ = Resize(img1, uint(img1.Bounds().Max.X/scale), uint(img1.Bounds().Max.Y/scale))

	img2, _ = Import(io.NewFileImporter("./testdata/soldier-708711_960_720.jpg"))
...
func TestImage(t *testing.T) {
	...
	Export(io.NewAnimationExporter(gif, "out.gif"))
}
