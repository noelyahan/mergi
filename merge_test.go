...
func TestMergeTemplate3(t *testing.T) {
	template := "TTBBB"
	large, _ := mergi.Import(io.NewFileImporter("./testdata/nature-3042751_960_720.jpg"))
	small, _ := mergi.Import(io.NewFileImporter("./testdata/evraiki-2514543_240_180.jpg"))
...
func TestMergeTemplate9(t *testing.T) {
	img, _ := mergi.Import(io.NewFileImporter("./testdata/evraiki-2514543_240_180.jpg"))
